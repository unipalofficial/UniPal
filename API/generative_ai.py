...
class GenAI():
    ...
    def initialize(self):
        ...
        return self._chat.send_message(list(json.load(open(os.getcwd() + '/Scraps/initializer.json', 'r')).values())[0].format(train_data)).text.strip() # Return first response message